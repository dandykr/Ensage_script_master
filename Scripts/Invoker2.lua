...
config:SetParameter("combo8", "N")
config:SetParameter("a1qqq", "n1")
config:SetParameter("a2qqw", "n2")
config:SetParameter("a3qww", "n3")
config:SetParameter("a4www", "n4")
config:SetParameter("a5wwe", "n5")
config:SetParameter("a6wee", "n6")
config:SetParameter("a7eee", "n7")
config:SetParameter("a8qee", "n8")
config:SetParameter("a9qqe", "n9")
config:SetParameter("a0qwe", "n0")
