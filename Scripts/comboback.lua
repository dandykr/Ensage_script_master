...
local F11 = drawMgr:CreateFont("F15","Tahoma",11*x_ratio,550*x_ratio) 
local statusText = drawMgr:CreateText(3*x_ratio,107*x_ratio,-1,"(" .. string.char(toggleKey) .. ") Pudge's humiliation: off",F15) statusText.visible = false
